...
export class CyberGoatzTrackFormComponent {
    ...
    readonly form = inject(FormBuilder).nonNullable.group({
        ...
        badgeName: ['', [Validators.maxLength(120)]],
        badgeDescription: ['', [Validators.maxLength(500)]],
        badgeImageUrl: ['', [Validators.maxLength(2048)]],
    ...
    private setTrack(track: CyberGoatzTrack): void {
        ...
        this.form.reset({
            ...
            badgeName: track.badgeName ?? '',
            badgeDescription: track.badgeDescription ?? '',
            badgeImageUrl: track.badgeImageUrl ?? '',
    ...
    private toTrackPayload(): CyberGoatzTrackPayload {
        ...
        return {
            ...
            badgeName: value.badgeName.trim() || null,
            badgeDescription: value.badgeDescription.trim() || null,
            badgeImageUrl: value.badgeImageUrl.trim() || null,
